  ...
  return (
    <div>
      ...
      <div className="hero-section w-full h-full flex items-center p-[2rem] mt-[6rem]">
        <div className="hero-content p-[1rem]">
          ...
          <button className="bg-[#504A77] text-white hover:text-black p-2 rounded mt-[1rem] hover:bg-[#C4DFFD] duration-500 ">
            Contactez-nous
          </button>
        </div>
        <div className="illustration flex w-[150rem] ">
